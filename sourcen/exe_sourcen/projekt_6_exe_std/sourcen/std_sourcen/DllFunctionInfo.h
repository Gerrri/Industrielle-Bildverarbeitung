...
#define	DLLDESCRIPTION				"projekt_6_std_vc.dll" 
...
#define	DLLFUNCTIONNAME0			A_projekt_6		//Funktionsname für Funktionsexport (Muß identisch mit
#define	DLLFUNCTIONNAMESTRING0		"A_projekt_6"		//DLLFUNCTIONNAMESTRING0 sein !
#define	DLLFUNCTIONDESCRIPTION0		"Zahlen_Lesen"	//Beschreibung der Funktion
...
#define	DLLFUNCTIONOUTPUTCOUNT0		1					//Anzahl der Ausgabebilder (n-1) (oder NOIMAGE)
    #define DLLFUNCTION0OUTPUTNAME0	"Out0"		//Name von Ausgabebild 0 (Wird in Ibv-Studio angezeigt)
    #define DLLFUNCTION0OUTPUTNAME1	"Kontrolle"					//Name von Ausgabebild 1 (Wird in Ibv-Studio angezeigt)
