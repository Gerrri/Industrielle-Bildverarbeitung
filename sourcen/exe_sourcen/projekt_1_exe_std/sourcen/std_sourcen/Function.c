...
// ###########################  ANPASSEN ANFANG ########################################
#include "..//..//sourcen//projekt_1_main.h"
// ###########################  ANPASSEN ENDE   ########################################
...
// ###########################  ANPASSEN ANFANG ########################################
    main_hist_ausgleich(CurrentFunctionName, CurrentParamSourcePointer);
// ###########################  ANPASSEN ENDE   ########################################
...
IBVSTUDIODLLEXPORT BOOL DLLFUNCTIONNAME1 ()
{
    ...
    main_rgb2hsi (CurrentFunctionName, CurrentParamSourcePointer);
...
IBVSTUDIODLLEXPORT BOOL DLLFUNCTIONNAME2 ()
{
    ...
    main_hsi2rgb (CurrentFunctionName, CurrentParamSourcePointer);
