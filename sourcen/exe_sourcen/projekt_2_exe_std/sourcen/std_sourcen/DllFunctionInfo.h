...
#define	DLLDESCRIPTION				"projekt_2_std_vc.dll"
...
#define	DLLFUNCTIONNAME0			A_max_min		//Funktionsname für Funktionsexport (Muß identisch mit
#define	DLLFUNCTIONNAMESTRING0		"A_max_min"		//DLLFUNCTIONNAMESTRING0 sein !
#define	DLLFUNCTIONDESCRIPTION0		"Erosion oder Dilatation eines BYTE-Bildes"	//Beschreibung der Funktion
...
#define	DLLFUNCTIONNAME1			B_Vergleich
#define	DLLFUNCTIONNAMESTRING1		"B_Vergleich"
#define	DLLFUNCTIONDESCRIPTION1		"Vergleich von zwei Bildern.."

#define	DLLFUNCTIONINPUTCOUNT1		1
	#define DLLFUNCTION1INPUTNAME0	"In0"
	#define DLLFUNCTION1INPUTNAME1	"In1"
