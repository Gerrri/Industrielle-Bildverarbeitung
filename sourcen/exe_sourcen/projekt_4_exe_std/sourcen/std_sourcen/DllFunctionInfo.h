...
#define	DLLDESCRIPTION				"projekt_4_std_vc.dll" 
...
#define	DLLFUNCTIONNAME0			A_projekt_4		//Funktionsname für Funktionsexport (Muß identisch mit
#define	DLLFUNCTIONNAMESTRING0		"A_projekt_4"		//DLLFUNCTIONNAMESTRING0 sein !
#define	DLLFUNCTIONDESCRIPTION0		"Regionen finden"	//Beschreibung der Funktion
				
#define	DLLFUNCTIONINPUTCOUNT0		1					//Anzahl der Eingabebilder (n-1) (oder NOIMAGE)
	#define DLLFUNCTION0INPUTNAME0	"In0"		//Name von Eingabebild 0 (Wird in Ibv-Studio angezeigt)
	#define DLLFUNCTION0INPUTNAME1	"In1"					//Name von Eingabebild 1 (Wird in Ibv-Studio angezeigt)
	...
	//...
#define	DLLFUNCTIONOUTPUTCOUNT0		1					//Anzahl der Ausgabebilder (n-1) (oder NOIMAGE)
	#define DLLFUNCTION0OUTPUTNAME0	"Out"		//Name von Ausgabebild 0 (Wird in Ibv-Studio angezeigt)
	#define DLLFUNCTION0OUTPUTNAME1	"Merker"					//Name von Ausgabebild 1 (Wird in Ibv-Studio angezeigt)
